...
<%--									<td><%=rs_a.getString("MApeople")%></td>--%>
<%--                                    <td><%=rs_a.getDouble("MApeople")*rs_a.getDouble("MAhis")*rs_a.getDouble("MAnow")%></td>--%>
                                    <td><% double x = rs_a.getDouble("MApeople") * 0.4 + 0.3 * rs_a.getDouble("MAhis")+ 0.3 * rs_a.getDouble("MAnow");
                                        BigDecimal y = new BigDecimal(x);
                                        float x1= y.setScale(2,BigDecimal.ROUND_HALF_UP).floatValue();
                                        out.print(x1);
                                    %></td>
                                 </tr>
                                <%
