																						...
																						<div class="side-widgets overflow">
																							...
																							<div class="text-center s-widget m-b-25 dropdown" id="profile-menu">
																								<a href="" data-toggle="dropdown" id="theimg">
																									<img class="profile-pic animated" src="img/profile-pic2.jpg" alt=""></a>
																								...
																								<!-- Feeds <div class="s-widget m-b-25"> <h2 class="tile-title"> News Feeds </h2> <div class="s-widget-body"> <div id="news-feed"></div> </div> </div>-->
                            	...
                            	%>
																											<div class="side-border">
																												...
																												<div class="progress progress-small">
																													<a href="${pageContext.request.contextPath}/AnchorProDanMuServlet?listMAname=<%=rs_a.getString(" MAname") %>"="MAname") %>"" data-toggle="tooltip" title="" class="tooltips progress-bar progress-bar-info" style="width: 60%;" data-original-title="60%">
																							...
																							<ul class="list-unstyled side-menu">
																								...
																								<li class="dropdown">
																									...
																									<ul class="list-unstyled menu-item">
																										<li>
																											<a data-drawer="messages" href="#">警报列表</a>
																										</li>
																										<li>
																											<a data-drawer="notifications" href="#">投诉列表</a>
																										</li>
																									</ul>
																								</li>
																							</ul>
																								...
																								<div class="listview narrow">
																									...
																									<div class="overflow" style="height: 20em">
																										<div class="media">
																											...
																											<div class="media-body">
																												<small class="text-muted">AC绅士向</small>
																												<br>
																													<a class="t-overflow" href="">类型：侮辱谩骂<span style="color:red">你妈逼的</span>
																													</a>
																												</div>
																											</div>
																										...
																										<div class="col-md-12">
																											<div class="col-md-6">
																												<div class="main-chart" style="height: 30.1em; width:60.1em;">
																													<jsp:include page="js/echarts/DM_peicharts.jsp"></jsp:include>
																												</div>
																											</div>
																											<div class="col-md-6">
																													...
																													<script>
																														function InsertIndex() {
																															...
																															$.post("DanMuInfoServlet", {
																																...
																																var contentStr = "";
																																$.each(json, function () {
																																	contentStr += "<tr><td>" + json[i].theIndex + "</td><td>" + json[i].Times + "</td><td>" + json[i].negTimes + "</td><td>" + json[i].neg + "%</td>" +
																																	// 										'<td><div class="pie-chart-tiny" data-percent="'+json[i].neg+'">'+                                         '<span class="percent"></span><span class="pie-title">消极指数</div></td>'+
																																	"<td>" + $.each(json[i].content, function () {
																																		var str = "";
